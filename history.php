...
<body class="bg-gray-50 min-h-screen">
    ...
    <script>
        ...
        function deleteBriefing(briefingId) {
            showDeleteModal(briefingId);
        }

        function showDeleteModal(briefingId) {
            const modalHtml = `
                <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div class="bg-white rounded-lg p-6 m-4 max-w-md">
                        ...
                        <div class="flex space-x-3">
                            <button onclick="confirmDelete('${briefingId}')" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded">
                                Delete
                            </button>
                            <button onclick="closeDeleteModal()" class="bg-gray-300 hover:bg-gray-400 text-gray-700 px-4 py-2 rounded">
                                Cancel
                            </button>
                        </div>
                    </div>
        ...
        function confirmDelete(briefingId) {
        ...
        function initializeCustomAudioPlayers() {
            ...
            audioPlayers.forEach(player => {
                ...
                if (!audio || !playPauseBtn || !progressContainer || !progressBar || !progressHandle || !currentTimeSpan || !durationSpan) {
                    console.warn('Audio player elements missing for player:', player);
                    return;
                }
