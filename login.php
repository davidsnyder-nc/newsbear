    ...
    <div class="max-w-md w-full space-y-8 p-8">
        ...
        <div class="bg-white shadow-lg rounded-lg p-8">
            <form method="POST" class="space-y-6">
                ...
                <button type="submit" class="w-full text-white font-medium py-2 px-4 rounded-md transition-colors duration-200" style="background-color: #3A2B1F; hover:background-color: rgba(58, 43, 31, 0.9);">
        ...
        <div class="text-center">
            <a href="index.php" class="text-sm text-gray-600" style="hover:color: #3A2B1F;">
