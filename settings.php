                        ...
                        <div class="space-y-6">
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="blockedTerms" rows="4" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm" placeholder="trump, elon musk, bitcoin"><?= getValue('blockedTerms') ?></textarea>
